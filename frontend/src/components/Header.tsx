    ...
    <header className="sticky top-0 z-50 border-b border-[#e6eef5] bg-white/92 backdrop-blur">
      <div className="site-container flex min-h-[76px] items-center justify-between gap-4 py-3">
        ...
        <nav className="flex items-center gap-1.5 sm:gap-2">
          <button type="button" onClick={toggleTheme} className="hidden h-10 w-10 items-center justify-center rounded-full text-[#476074] transition hover:bg-[#f3f8fc] hover:text-[#123e67] lg:flex" aria-label="تبديل المظهر">
            {darkMode ? (
